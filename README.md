...
Install the Extension from [VSCode Marketplace](https://marketplace.visualstudio.com/items?itemName=Dootmaan.kimi-for-copilot) or search `Kimi Models for GitHub Copilot Chat` in VSCode Extension Store.
