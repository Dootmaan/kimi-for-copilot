...
import type { KimiToolCall, KimiUsage, RetryBackoffInfo, StreamCallbacks } from '../types';
...
/** Drive the Kimi stream and forward parts to Copilot Chat. */
...
/**
 * Report usage as a Copilot Chat usage data part. Kimi returns `cached_tokens` flat; we map it
 * into `prompt_tokens_details.cached_tokens` to match the shape Copilot expects.
 */
